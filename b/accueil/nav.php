    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center flex-equal">
                ...
                <!--begin::Logo image-->
                <a href="./">
                    <img alt="Logo" src="logo-supnum2.png"
                    ...
                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold"
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="./"
                               data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Comment ça fonctionne</a>
                            <!--end::Menu link-->
                        </div>
                        <div class="menu-item">
                            <!--begin::Menu link-->
                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="./matieres.php"
                               data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Evaluation</a>
                            <!--end::Menu link-->
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
            ...
            <?php
                ...
                if (isset($_SESSION['U'])) {
                    echo('<a href="../logout.php" class="btn btn-secondary">Se déconnecter</a>');
                } else {
